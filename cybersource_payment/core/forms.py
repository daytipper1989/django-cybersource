...
class PaymentForm(forms.Form):
	transaction_type = forms.CharField(label = _('Transaction Type'),max_length=25,required=True,initial="create_payment_token",disabled=True)
	...
	amount = forms.DecimalField(label = _('Amount'),required=True,min_value=0.1,decimal_places=2)
